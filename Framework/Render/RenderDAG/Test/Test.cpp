...
int main()
{
    ...
    auto                                 deferLightingPass = dag.AddPassNode("Defer Lighting", {gbuffer0, gbuffer1, gbuffer2}, {deferLightedRT});
    auto                                 gbPass            = dag.AddPassNode("GBuffer Pass", {}, {gbuffer0, gbuffer1, gbuffer2});
