...
DeviceVk::DeviceVk(VulkanFactory *factory) : m_pVukanFactory(factory)
{
    m_pVInstance = factory->m_pVInstance;
    m_surfaceKHR = factory->m_surfaceKHR;
}
...
void DeviceVk::PickPhysicalDevice()
{
    ...
    vkEnumeratePhysicalDevices(m_pVInstance->GetVkInstance(), &deviceCount, nullptr);
    ...
    auto err = vkEnumeratePhysicalDevices(m_pVInstance->GetVkInstance(), &deviceCount, devices.data());
